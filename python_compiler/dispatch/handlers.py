from ..operations.llvm import OpDeclarations, OpStmt, OpReturn, OpPrintnl
from ..operations.llvm import OpUnarySub, OpCallFunc, OpNewConst, OpAdd
from ..operations.llvm import OpAssign

#from ..operations.llvm import 
